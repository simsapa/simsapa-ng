...
DROP INDEX IF EXISTS idx_book_spine_items_book_uid_resource_path;
...
DROP INDEX IF EXISTS idx_book_spine_items_language;
DROP INDEX IF EXISTS idx_book_spine_items_resource_path;
